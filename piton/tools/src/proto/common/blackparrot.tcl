...
set BLACKPARROT_RTL_IMPL_FILES [list \
    ...
    "${DV_ROOT}/design/chip/tile/blackparrot/black-parrot/bp_common/src/v/bsg_mem_1r1w_sync.v" \
    "${DV_ROOT}/design/chip/tile/blackparrot/black-parrot/bp_common/src/v/bsg_mem_1r1w_sync_synth.v" \
...
set file "${DV_ROOT}/design/chip/tile/blackparrot/black-parrot/bp_common/src/v/bsg_mem_1r1w_sync.v"

set file_obj [get_files -of_objects [get_filesets sources_1] [list "$file"]]
set_property -name "file_type" -value "SystemVerilog" -objects $file_obj

set file "${DV_ROOT}/design/chip/tile/blackparrot/black-parrot/bp_common/src/v/bsg_mem_1r1w_sync_synth.v"
